...
const MARKER = "<!-- simple-snapshot-audit -->";
const NAME = "Simple Snapshot Audit";
  ...
  const shouldFail =
    failOn === "high"
      ...
      : failOn === "medium"
        ...
        : false;
  if (shouldFail) core.setFailed(`simple-snapshot-audit: ${findings.length} finding(s) (fail-on=${failOn})`);
